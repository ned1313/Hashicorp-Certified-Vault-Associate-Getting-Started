...
$resp = Invoke-WebRequest -Uri "$env:VAULT_ADDR/v1/GloboKV/data/apitokens/d102" `
...
$resp = Invoke-WebRequest -Uri "$env:VAULT_ADDR/v1/GloboKV/data/apitokens/d102?version=1" `
  -UseBasicParsing -Headers $headers
